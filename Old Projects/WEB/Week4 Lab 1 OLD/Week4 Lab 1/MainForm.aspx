    ...
    <form id="form1" runat="server">
        <div id="InputContainer">
            ...
            <div>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtEmail" ErrorMessage="* Enter a proper email" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic" Font-Bold="False" Font-Names="Arial" Font-Size="Smaller" ForeColor="Red"></asp:RegularExpressionValidator>
            </div>
            <div>
